...
jQuery(document).ready(function($) {
    ...
    $('#fullpage').fullpage({
        anchors: ['landing-section', 'schedules-section', 'tickets-section', 'downloads-section', 'playlist-section', 'sponsors-section', 'faq-section', 'outtro-section'],
        ...
        onLeave: function() {
            ...
            setTimeout(function() {
                clearSVGs();
                if ($('#schedules').hasClass('active') || $('#faq').hasClass('active')) {
                    $('.m-navbar').addClass('schedules-active');
                } else {
                    $('.m-navbar').removeClass('schedules-active');
                }
            }, 400);
            $(window).trigger('scroll');
        },
        onSlideLeave: function(anchorLink, index, slideIndex, direction, nextSlideIndex) {
            var thisAnimLeaving;
            $(window).trigger('scroll');
            if (anchorLink == "schedules-section") {
        ...
        afterSlideLoad: function(anchorLink, index, slideAnchor, slideIndex) {
            if (anchorLink == "schedules-section") {
                ...
                setTimeout(function() {
                    if (slideIndex !== 0) {
                        $('.m-schedules__header').addClass('is-visible');
                    } else if ($('.m-schedules__header').hasClass('is-visible')) {
                        $('.m-schedules__header').removeClass('is-visible');
                    }
                }, 1500);
            }
        },
    ...
    $('m-schedules__h-title').click(function() {
        $.fn.fullpage.moveTo('schedules-section', 0);
    });
    setTimeout(function() {
    ...
    $(window).load(function() {
        ...
        new MainNav();
        $(window).trigger('scroll');
        $('.m-schedule-slide__control--prev').click(function() {
            $.fn.fullpage.moveSlideLeft();
        });
        $('.m-schedule-slide__control--next').click(function() {
    ...
    var scheduleContainerHeight = $('.schedules-section .fp-slides ul').height();
